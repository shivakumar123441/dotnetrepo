...
public class CurrentUserTransactionDetailsDto : IMapFrom<Transaction>
{
    ...
    public void Mapping(Profile profile) => profile.CreateMap<Transaction, CurrentUserTransactionDetailsDto>()
