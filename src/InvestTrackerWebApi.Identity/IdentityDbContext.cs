...
using InvestTrackerWebApi.Identity.Extensions;
...
public class IdentityDbContext :
    IdentityDbContext<ApplicationUser, ApplicationRole, string, ApplicationUserClaim, ApplicationUserRole, ApplicationUserLogin, ApplicationRoleClaim, ApplicationUserToken>, IIdentityDbContext
{
    ...
    public IdentityDbContext(DbContextOptions<IdentityDbContext> options, ILoggerFactory loggerFactory)
